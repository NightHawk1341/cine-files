...
Router.registerPage('/:category/:slug', {
  ...
  async init(params) {
    ...
    try {
      var article = await Utils.apiFetch('/api/articles/' + encodeURIComponent(params.slug));
      ...
      if (article.author_name) {
        ...
        authorLink.href = '/author/' + article.author_id;
